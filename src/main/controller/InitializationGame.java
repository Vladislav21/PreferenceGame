...
import main.model.ConditionsGame;
import main.model.Distributor;

public class InitializationGame {

    public void setConditionsGame(ConditionsGame game, int amountOfDistribution, int amountOfBullets) {
        game.setAmountOfDistribution(amountOfDistribution);
        game.setAmountOfBullets(amountOfBullets);
    }
